      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <a
            v-if="isDev"
            target="_blank"
            href="http://localhost:9637/_codegen?ui=vue"
          >
            <el-dropdown-item>{{ $t("navbar.generation") }}</el-dropdown-item>
          </a>
          <a v-if="isDev" target="_blank" href="http://localhost:9637/swagger">
...
import TenantSelect from "@/components/frame/TenantSelect/index.vue";
