...
namespace WTM.VoteSystem.DataAccess
{
    public class DataContext : FrameworkContext
    {
        ...
        public DbSet<SystemActivity> SystemSystemActivityUser { get; set; }
        ...
        {
            builder.Entity<SystemUser>(c =>
            {
                c.HasOne(c => c.Role).WithMany(c => c.SystemUsers).HasForeignKey(c => c.RoleId);
                c.HasMany(c => c.SystemCandidateManagers).WithOne(c => c.SystemUser).HasForeignKey(c => c.SystemUserId);
            });
            builder.Entity<SystemActivity>(c =>
            {
                c.HasMany(c => c.SystemCandidateManagers).WithOne(c => c.SystemActivity).HasForeignKey(c => c.SystemActivityId);
