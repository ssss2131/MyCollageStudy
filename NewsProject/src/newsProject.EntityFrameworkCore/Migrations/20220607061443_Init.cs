        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    title = table.Column<string>(type: "varchar(255)", nullable: true, collation: "utf8_bin"),
                    stitle = table.Column<string>(type: "varchar(255)", nullable: true, collation: "utf8_bin"),
                    data = table.Column<string>(type: "longtext", nullable: true, collation: "utf8_bin"),
                    category = table.Column<string>(type: "varchar(255)", nullable: true, collation: "utf8_bin"),
                    clickNum = table.Column<int>(type: "int(11)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_article", x => x.newId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
